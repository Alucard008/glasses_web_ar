...
import NewGLTFModelRing from '../../assets/VTO/ring3.glb';
...
const SETTINGS = {
  ...
  models: {
    ...
    ringDemo: {
      VTOMode: 'ring',
      model: NewGLTFModelRing, // Use the new ring model
      scale: 1, // Adjust this scale as needed
      translation: [-1.66, -11.91, 0.26], // Adjust this translation as needed
