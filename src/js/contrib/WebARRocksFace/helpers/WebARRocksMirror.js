    ...
    newMat.onBeforeCompile = function (shaders) {
      ...
      if (glassesBranchesSpec) {
        const glassesBranchUniforms = {
          uBranchFading: {
            value: new Vector2(
              glassesBranchesSpec.fadingZ,
              glassesBranchesSpec.fadingTransition
            ),
          }, // first value: position (lower -> to the back), second: transition brutality
          uBranchBendingAngle: {
            value: glassesBranchesSpec.bendingAngle * _d2r,
          },
  ...
  const that = {
      ...
      return new Promise(function (resolve, reject) {
        ...
        const threeHelperSpec = {
          ...
          callbackTrack: function (detectState) {
            WebARRocksFaceLightingHelper.update_lightReconstruction(
              detectState
            );
    ...
    tweak_materials: function (threeObject3D, glassesBranchesSpec) {
      threeObject3D.traverse(function (threeStuff) {
        ...
        // Tweak material:
        threeStuff.material = tweak_material(
          threeStuff.material,
          isGlassesBranch ? glassesBranchesSpec : null
        );
    ...
    set_faceFollower: function (faceFollowerParent, faceFollower, faceIndex) {
      ...
      WebARRocksFaceThreeHelper.set_faceFollower(
        faceFollowerParent,
        faceFollower,
        faceIndex
      );
